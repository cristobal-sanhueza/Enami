...
Modelados <- list.files(path = "Geoaire/ENAMI/Modelados/2022/11.Noviembre/SO2",    
                        pattern = "*.xlsx",
                        full.names = TRUE)
...
write_excel_csv(first_sheet_contents, file = "Geoaire/ENAMI/Modelados/2022/11.Noviembre/SO2/Combinados/Copiapo.csv")

write_excel_csv(second_sheet_contents, file = "Geoaire/ENAMI/Modelados/2022/11.Noviembre/SO2/Combinados/LosVolcanes.csv")

write_excel_csv(third_sheet_contents, file = "Geoaire/ENAMI/Modelados/2022/11.Noviembre/SO2/Combinados/SanFdo.csv")

write_excel_csv(fourth_sheet_contents, file = "Geoaire/ENAMI/Modelados/2022/11.Noviembre/SO2/Combinados/Paipote.csv")

write_excel_csv(fifth_sheet_contents, file = "Geoaire/ENAMI/Modelados/2022/11.Noviembre/SO2/Combinados/TierraAmarilla.csv")

####################################################################################################################################

write_excel_csv(sixth_sheet_contents, file = "ENAMI/Modelados/2022/7.Julio/SO2/Combinados/.csv")

write_excel_csv(seventh_sheet_contents, file = "ENAMI/Modelados/2022/7.Julio/SO2/Combinados/.csv")
